...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu){
        ...
        //查询分类
        List<Category> list = categoryClient.queryCategoryByIds(Arrays.asList(spu.getCid1(), spu.getCid2(), spu.getCid3()));
    ...
    public PageResult<Goods> search(SearchRequest request) {
        ...
        //2结果过滤,source源过虑设置，指定结果中所包括的字段有哪些。
